fixvarfunc <- function(data) {
  # Cut outcomes death at 1 year
  data <- cut_surv(data, sos_out_death, sos_outtime_death, global_fu, cuttime = FALSE, censval = "No")
  data <- cut_surv(data, sos_out_deathcv, sos_outtime_death, global_fu, cuttime = FALSE, censval = "No")
  data <- cut_surv(data, sos_out_deathnoncv, sos_outtime_death, global_fu, cuttime = TRUE, censval = "No")
...
rsdata <- fixvarfunc(rsdata)
rsdata_sens <- fixvarfunc(rsdata_sens)
