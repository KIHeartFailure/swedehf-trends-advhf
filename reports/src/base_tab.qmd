...
tab <- tab %>%
  mutate(
    ...
    footnote2 = if_else(!is.na(var) & var %in% c("shf_sglt2"), footnote_marker_alphabet(2, format = "latex"), ""),
    footnote3 = if_else(!is.na(var) & str_detect(var, "_tg"), footnote_marker_alphabet(3, format = "latex"), ""),
    footnote4 = if_else(!is.na(var) & var %in% c("shf_mra_tg"), footnote_marker_alphabet(4, format = "latex"), ""),
    footnote5 = if_else(!is.na(var) & var %in% c("shf_rasiarni_tg"), footnote_marker_alphabet(5, format = "latex"), ""),
  ) %>%
