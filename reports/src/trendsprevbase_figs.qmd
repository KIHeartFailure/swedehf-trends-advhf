...
trendbasefunc <- function(data = rsdata, strata = NULL, addstrataname = NULL, ybreaks = seq(0, 100, 20), addpos = "first") {
...
trendbasefunc(strata = "shf_bbl", addstrataname = "Beta-blocker", addpos = "last")
trendbasefunc(strata = "shf_rasiarni", addstrataname = "RASi/ARNi", addpos = "last")
trendbasefunc(strata = "shf_mra", addstrataname = "MRA", addpos = "last")
```
...
#| fig-subcap: !expr c("Sex", "CCI", "Beta-blocker", "RASi/ARNi", "MRA")
#| layout-ncol: 2
#| layout-nrow: 3
